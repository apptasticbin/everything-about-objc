...
- (void)setupRootViewController {
    ...
    if (self.window) {
        self.window.rootViewController = [[RootNavigationController alloc]
...
- (NSURL *)applicationDocumentsDirectory {
    ...
    // This code uses a directory named "biyu.everything_about_objc" in the
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL =
        [[NSBundle mainBundle] URLForResource:@"everything_about_objc"
                                withExtension:@"momd"];
    _managedObjectModel =
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory]
        URLByAppendingPathComponent:@"everything_about_objc.sqlite"];
    NSError *error = nil;
